          ...
          <div class="introduction about">
            <div>
              <p class="psobre">
                ...
                PHP | HTML | CSS | JavaScript e usa serealização para salvar as informações dos usuarios e dos livros upados no mesmo. Esse projeto teve seu design completamente refeito principalmente para 
                retirar o layout feito com tabelas que era usado para organizar os livors ofertados por esse site. Mesmo assim é um projeto ainda inacabando que vai ser mais trabalhado em outro momento.
              </p>
            </div>
          </div>  
        </div>  
