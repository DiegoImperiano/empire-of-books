...
class Biblioteca {
    ...
    public static function serializar(Biblioteca $biblioteca) : void {
        // begin serialização
        $file = fopen("../frontend/biblioteca.data", "w");
    ...
    public static function desserializar() : Biblioteca {
        if (file_exists("../frontend/biblioteca.data")) {
            // begin desserialização...
            $file = fopen("../frontend/biblioteca.data", 'r');
            $content = fread($file, filesize("../frontend/biblioteca.data"));
